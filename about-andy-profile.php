<?php
	/* Template Name: About - Andy Profile */
	include 'php-includes/global-functions.php';
	get_header();
?>
<body> 
	<?php get_inner_site_header('About ISD', 'Andy Atkinson', '', '', $bcs = array('Homepage' => home_url(), 'About ISD' => get_permalink(13), 'Andy Atkinson' => ''), 'about-isd--reverse.svg#about'); ?>
	<!-- FAQs -->
		...
		<article class="bc-feature-component__content">
			<div class="bc-gr-feature isd-staff-profile ">	
				...
				<div class="bc-gr-feature__text">
					<h1 class="bc-inner-page-content__heading">Andy Atkinson</h1>
					<h2>Director</h2>
