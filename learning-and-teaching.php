<?php
	/* Template Name: Learning & Teaching */
	...
	<section class="bc-feature-component has-shade-01">   
		<header class="bc-feature-component__header">
			<div class="bc-feature-component__content__text-content">
				...
				<p class=""><strong><em>&quot;Imagine a worldwide community of schools, educators and students with a shared vision and mission to empower young people with the skills, values and knowledge to create a better and more peaceful world. This is the International Baccalaureate”</em></strong></p> 
		...
		<div class="bc-feature-component__content ">
			...
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block has-colored-text">
				<picture class="bc-gr-feature__media">
					<img src="<?php echo get_theme_file_uri('media/ib-world-school-logo-2-colour.png'); ?> " alt="The International Baccalaureate">
				</picture>
			...
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block has-colored-text">
				<picture class="bc-gr-feature__media">
					<img src="<?php echo get_theme_file_uri('/media/ib-world-school-continuum.png'); ?>" alt="The International Baccalaureate">
				</picture>
				<div class="bc-gr-feature__text">
					<h2 class="bc-gr-feature__heading">IB Key Components</h2>
					<p class="bc-gr-feature__intro">Four key components form the basis of an IB education:</p>  
					<ol>
						<li>Inquiry</li>
					...
					<div class="bc-expandible-block__body">
						<h2>1. Inquiry</h2>
						<p><strong>The search for meaning is fundamental to what it is to be human.</strong></p>
						<p>Curiosity, asking questions and making sense of the world activates higher-order thinking on many levels. Inquiry focuses on understanding concepts and making connections that enhance learning.</p> 
						<p>At ISD we strive for our students to be active inquirers, learners who are engaged in educational material and experiences. Throughout the curriculum, students are guided by the inquiry cycle.</p> 
						<p>The nature of a cycle is flexible and never ending, a process of which one may move forward, backward and in all directions. The cycle provides opportunities for students to navigate their learning in a personally significant manner.</p>
						<img src="<?php echo get_theme_file_uri('/media/ISD-inquiry-cycle.png'); ?>" alt="ISD Inquiry Cycle" />
						<h2>2. Student Centred</h2>
						<p><strong>Placing learners at the heart of the learning process shifts the focus and ownership of education from the teacher to student. It provides choice, agency and self-efficacy.</strong></p>
						<p>A student-centred approach allows learners to retain far more knowledge. At ISD learning begins with reflecting on prior knowledge. Teachers gently guide, encourage and inspire students to build upon what they already know, making connections and developing questions for exploration.</p> 
						<p>Through experiences and interactions, students naturally develop intricate, multi-layered perceptions and understandings. When students are agents of their own learning, they become responsible for and take ownership of the learning processes.</p> 
						<p><em>“Tell me and I forget. Teach me and I remember. Involve me and I learn.”</em> <strong>--Benjamin Franklin</strong></p>
						<h2>3. Skills for the Future</h2>
						<p><strong>In an ever changing world, the future is unpredictable.</strong></p>
						<p>We do not know what kind of world our students will grow up in. At ISD, we prepare our learners for the unknown by creating learning experiences with meaningful and authentic contexts.</p>
						<p>This provides students the opportunities to develop a toolkit of skills to draw upon throughout life. We encourage the development of a well rounded learner with character, someone who:</p>
						<ul>
							<li>engages and is eager to learn</li>
							<li>thinks for themselves</li>
							<li>is capable of collaboration</li>
							<li>responds to real-life situations and challenges with optimism</li>
							<li>exhibits confidence, responsibility and all traits of the <a href="https://www.ibo.org/benefits/learner-profile/">IB Learner Profile</a></li>
							<li>continually reflects</li>
							<li>is internationally-minded</li>
						</ul>
						<h2>4. Global Contexts</h2> 
						<p><strong>The IBPYP curriculum framework is guided by six transdisciplinary themes of global significance.</strong></p> 
			...
			<article class="bc-gr-feature bc-gr-columns  bc-expandible-block   has-colored-text">
				<picture class="bc-gr-feature__media">
					...
					<img src="<?php echo get_theme_file_uri('/media/student-learning-about-electronics.jpg'); ?>" alt="Benefits of an International Baccalaureate Education"> 
				</picture>
				<div class="bc-gr-feature__text">
			...
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block has-colored-text"> 
				<picture class="bc-gr-feature__media">
					<img src="<?php echo get_theme_file_uri('/media/pyp-model-2018.png'); ?>" alt="The IB Primary Years Programme">
				</picture>
				<div class="bc-gr-feature__text">
			...
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block   has-colored-text"> 
				<picture class="bc-gr-feature__media">
					<img src="<?php echo get_theme_file_uri('/media/learner-profile-logo-en.png'); ?>" alt="The IB Learner Profile">
				</picture>
				<div class="bc-gr-feature__text">
			...
			<!-- Language Support -->
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block has-colored-text" id="language-support">
				<picture class="bc-gr-feature__media">
					<img src="<?php echo get_theme_file_uri('/media/children-playing-sports.jpg'); ?>" alt="Children during sports day">
				</picture>
				<div class="bc-gr-feature__text">
