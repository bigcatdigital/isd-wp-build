<?php
	/* Template Name: Teaching & Learning */
	include 'php-includes/global-functions.php';
	get_header();
?>
<body> 
	<?php get_inner_site_header('Learning and Teaching', '', 'More about Learning and Teaching', array('Timetable' => 'javascript:void(0)', 'Subjects' => 'javascript:void(0)', 'Class groupings' => 'javascript:void(0)', 'Catered lunch program' => 'javascript:void(0)', 'Additional services' => 'javascript:void(0)', 'School uniform' => 'javascript:void(0)', 'School calendar' => 'javascript:void(0)')); ?> 
		...
		<div class="bc-feature-component__content ">
			...
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block has-colored-text">
				<picture class="bc-gr-feature__media bc-column">
					<img src="<?php echo get_theme_file_uri('media/inquiry-based-learning3.jpg'); ?> " alt="The International Baccalaureate">
				</picture>
			...
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block   has-colored-text">
				<picture class="bc-gr-feature__media bc-column">
					<img src="<?php echo get_theme_file_uri('/media/ib-world-school-logo-1-colour.svg'); ?>" alt="The International Baccalaureate">
				</picture>
				<div class="bc-gr-feature__text bc-column">
			...
			<article class="bc-gr-feature bc-gr-columns  bc-expandible-block   has-colored-text">
				<picture class="bc-gr-feature__media bc-column">
					...
					<img src="<?php echo get_theme_file_uri('/media/student-centred-learning1.jpg'); ?>" alt="Benefits of an International Baccalaureate Education"> 
				</picture>
				<div class="bc-gr-feature__text bc-column">
			...
			<article class="bc-gr-feature bc-gr-columns bc-expandible-block has-colored-text"> 
				<picture class="bc-gr-feature__media bc-column">
					<img src="<?php echo get_theme_file_uri('/media/inquiry-based-learning1.jpg'); ?>" alt="Happy kids">
				</picture>
				<div class="bc-gr-feature__text bc-column">
