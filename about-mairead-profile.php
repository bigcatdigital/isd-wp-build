<?php
	/* Template Name: About - Mairead Profile */
	include 'php-includes/global-functions.php';
	get_header();
?>
<body> 
	<?php get_inner_site_header('About ISD', 'Mairead Lawyer', '', '', $bcs = array('Homepage' => home_url(), 'About ISD' => get_permalink(13), 'Mairead Lawyer' => ''), 'about-isd--reverse.svg#about'); ?>
	<!-- FAQs -->
		...
		<article class="bc-feature-component__content">
			<div class="bc-gr-feature isd-staff-profile isd-staff-profile--no-photo">
				<div class="bc-gr-feature__text ">
					<h1 class="bc-inner-page-content__heading">Mairead Lawyer</h1>
