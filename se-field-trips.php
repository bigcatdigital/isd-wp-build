<?php
	/* Template Name: Student Experience - Field Trips */
	include 'php-includes/global-functions.php';
	get_header();
?>
<body> 
	<?php get_inner_site_header('Student Experience', 'Field Trips and Guest Speakers', 'More About Student Experience', array('End of Unit Sharing' => '' . get_permalink(112) . '', 'Field Trips and Guest Speakers' => '' . get_permalink(136) . ''), array('Homepage' => home_url(), 'Student Experience' => get_permalink(24), 'Field Trips' => ''), 'pupil-experience-reverse.svg#experience--rev'); ?>
	<!-- Main -->
	<section class="bc-feature-component">     
		<article class="bc-feature-component__content">
			<div class="bc-feature-component__content__text-content">
				<h1 class="bc-inner-page-content__heading">Field Trips and Guest Speakers</h1>	
				<p class="bc-feature-component__intro">See some of our previous Field Trip and Guest Speaker events.</p>
