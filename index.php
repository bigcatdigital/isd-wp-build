...
<body> 
	<header class="bc-site-header">
		<div class="bc-site-header__content">
			<div class="bc-site-header__logo">
				<img src="<?php echo get_theme_file_uri('/media/isd-logo.png'); ?>" alt="International School of Dublin" class="">					
			</div>
	...
	<section class="bc-feature-component bc-site-index">
		<article class="bc-feature-component__content">
				...
				<p class="bc-feature-component__intro">Site code and content for the website.</p>
				<p>Each of the page titles (eg &quot;<em>Landing page</em>&quot;) is a link to a page which shows the content for that page.</p>
				<p>This shows the majority of the conent in the site and it shows all design elements that will be use.</p>
				<hr>
				<h2>Site build</h2>
				...
				<ul>
					<li>
						<h4><a href="<?php echo get_permalink(18) ?>" class="">Home page</a></h4>
					</li>
					<li>
					...
					<li>
						<h4><a href="<?php echo get_permalink(20) ?>" class="">Admissions</a></h4>
						<ul>
							<li><a href="<?php echo get_permalink(22) ?>">Admissions FAQ</a></li>
						</ul>
					</li>
					<li>
						<h4><a href="<?php echo get_permalink(13) ?>" class="">About ISD</a></h4>
					</li>
					<!--<li>
